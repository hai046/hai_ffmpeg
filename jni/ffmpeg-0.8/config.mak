...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --prefix=android/armv7-a --enable-cross-compile --extra-libs=-lgcc --arch=arm --cc='d:/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc' --cross-prefix='d:/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-' --nm='d:/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-nm' --sysroot='d:/android-ndk-r8/platforms/android-8/arch-arm' --extra-cflags=' -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums  -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=vfpv3-d16 -marm -march=armv7-a  ' --disable-shared --enable-static --extra-ldflags='-Wl,-rpath-link=d:/android-ndk-r8/platforms/android-8/arch-arm/usr/lib -Ld:/android-ndk-r8/platforms/android-8/arch-arm/usr/lib  -nostdlib -lc -lm -ldl -llog' --disable-everything --enable-demuxer=mov --enable-demuxer=h264 --disable-ffplay --enable-protocol=file --enable-avformat --enable-avcodec --enable-decoder=rawvideo --enable-decoder=mjpeg --enable-decoder=h263 --enable-decoder=mpeg4 --enable-decoder=h264 --enable-parser=h264 --disable-network --enable-zlib --disable-avfilter --disable-avdevice
...
SRC_PATH="/cygdrive/f/ffmpegtest/jni/ffmpeg-0.8"
SRC_PATH_BARE=/cygdrive/f/ffmpegtest/jni/ffmpeg-0.8
CC_IDENT=gcc 4.4.3 (GCC)
ARCH=arm
CC=d:/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc
AS=d:/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc
LD=d:/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc
DEPCC=d:/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc
YASM=yasm
YASMDEP=yasm
AR=d:/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-ar
RANLIB=d:/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=d:/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-strip
CPPFLAGS= --sysroot=d:/android-ndk-r8/platforms/android-8/arch-arm -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC
...
CC_O=-o $@
LDFLAGS= -Wl,-rpath-link=d:/android-ndk-r8/platforms/android-8/arch-arm/usr/lib -Ld:/android-ndk-r8/platforms/android-8/arch-arm/usr/lib -nostdlib -lc -lm -ldl -llog --sysroot=d:/android-ndk-r8/platforms/android-8/arch-arm -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link,libpostproc -Wl,-rpath-link,libswscale -Wl,-rpath-link,libavfilter -Wl,-rpath-link,libavdevice -Wl,-rpath-link,libavformat -Wl,-rpath-link,libavcodec -Wl,-rpath-link,libavutil
